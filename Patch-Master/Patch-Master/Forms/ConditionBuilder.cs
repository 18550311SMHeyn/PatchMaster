...
namespace Patch_Master.Forms
{
    public partial class NameConditionBuilder : Form
    {
        ...
        public void LoadTableList()
        {
            ...
            //if (tableList != null)
           // {
               // prevtableCount = tableList.Count();
            //}
            ...
            {
                case "1":
                    tableList = SelectQueryBuilder.AddedTableList;
                    break;
                case "3":
                    tableList = UpdateQueryBuilder.AddedTableList;
                    break;
            }
            ...
            //if (prevtableCount != 0 && prevtableCount != tableList.Count()){
                TableChange();
