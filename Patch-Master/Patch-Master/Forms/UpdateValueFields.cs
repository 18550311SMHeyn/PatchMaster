...
{
    public partial class UpdateValueFields : Form
    {
        string clickedElementName = "";
        UpdateFields ConditionGenerationForm;
        public UpdateValueFields()
        {
            InitializeComponent();
            LoadTableList();
        }
        #region New Computation Condition
        public UpdateValueFields(string elementName, UpdateFields conditionForm)
        {
            InitializeComponent();
        ...
        {
            List<string> tableList = UpdateQueryBuilder.AddedTableList;
