...
namespace Patch_Master.Forms
{
    public partial class Requirements : Form
    {
        ...
        public static string REQUIREMENTDES = string.Empty;
        ...
        private void Requirements_dataGridView_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            textBoxtestR.Text = Requirements_dataGridView.Rows[rowindex].Cells[8].Value.ToString();
            REQUIREMENTNAME = RequirementName_textBox.Text;
            REQUIREMENTDES = RequirementDescription_richTextBox.Text;
            if (NavigatedFrom == "Formulate")
            {
        ...
        private void AddRequirement_button_Click(object sender, EventArgs e)
        {
            ...
            AddRequirements(RequirementName, RequirementDescription, RequirementObjective, Test);
            AddReqGroupBox.Visible = false;
            DisplayRequirement_comboBox.Visible = true;
            this.clearRequirment();
        }
        private void AddRequirements(string requirementName, string requirementDescription, string requirementObjective, string Test)
        {
            ...
            try
            {
                ...
                sqlParams.Add(new SqlParameter("Test", Test));
                var dataReaders = dbContext.ExecuteQueryWithIDataReader(queryString, sqlParams);
        ...
        public void clearRequirment()
        {
            ...
            textBoxReqName.Text = string.Empty;
            richTextBoxObjective.Text = string.Empty;
