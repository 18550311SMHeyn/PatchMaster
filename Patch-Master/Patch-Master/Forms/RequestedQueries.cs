    ...
    public partial class RequestedQueries : Form
    {
        ...
        private void buttonExecute_Click(object sender, EventArgs e)
        {
            ...
            if (textBoxQueryType.Text == "UPDATE")
            {
                ...
                PrimaryTable= PrimaryTable.Trim();
            ...
            numberOfRecords = dtQueryResults.Rows.Count;
        ...
        private void setExecutionStatus(int RequestedQueryID, int RequestID)
        {
            ...
            try
            {
                ...
                sqlParams.Add(new SqlParameter("NoOfRecordsAffected", numberOfRecords));
