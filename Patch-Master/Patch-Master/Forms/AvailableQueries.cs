...
namespace Patch_Master.Forms
{
    public partial class AvailableQueries : Form
    {
        ...
        public static string selectedSubProcessId;
        public static string selectedDatabaseID;
        ...
        public AvailableQueries(Requirements Passedrequirements)
        {
            ...
            selectedSubProcessId = (((KeyValuePair<int, string>)requirements.SubProcess_comboBox.SelectedItem).Key).ToString();
            selectedDatabaseID = (((KeyValuePair<int, string>)requirements.comboBoxDatabase.SelectedItem).Key).ToString();
            CheckLogin();
            LoadSavedQueriesGrid();
        }
